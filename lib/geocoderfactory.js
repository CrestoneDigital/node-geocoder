...
var RequestNAdapter = require('./httpadapter/requestnadapter.js');
...
var PitneyBowesGeocoder = require('./geocoder/pitneybowesgeocoder.js');
...
var GeocoderFactory = {
  ...
  */
  _getHttpAdapter: function(adapterName, options) {
    ...
    if (adapterName === 'requestn') {
      return new RequestNAdapter(null, options);
    }
  },
  /**
  ...
  */
  _getGeocoder: function(geocoderName, adapter, extra) {
    ...
    if (geocoderName === 'pitneybowes') {
      return new PitneyBowesGeocoder(adapter, extra.apiKey);
    }
